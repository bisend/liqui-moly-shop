 ...
 * Generated for Laravel 5.4.28 on 2017-09-05.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Auth {
         ...
         *
         * @return \App\DatabaseModels\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \App\DatabaseModels\User|false 
         * @static 
         */ 
         ...
         *
         * @return \App\DatabaseModels\User 
         * @static 
         */ 
...
namespace  { 
    ...
    class URLify extends \App\Helpers\URLify {}
