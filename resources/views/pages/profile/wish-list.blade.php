                                                        ...
                                                        <div class="col-xs-12 col-sm-2 no-margin">
                                                            <div class="text-right">
                                                                <div class="add-cart-button">
                                                                    <a class="le-button add_to_cart_button product_type_simple" href="cart.html.html">В кошик</a>
                                                                </div>
                                                            </div>
                                                        </div>
