 ...
 * Serbian, and Azerbaijani. Symbols it cannot slugerate
 * it will simply omit.
 *
 * Usage:
 *
...
class URLify {
     ...
     * @param string $language The slugeration language, passed down to downcode()
     ...
     * @return mixed
     */
    public static function slugerate ($text) {
